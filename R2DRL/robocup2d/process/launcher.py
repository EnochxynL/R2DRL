...
def launch_server(
    *,
    ...
    args += [
        ...
        "--server::team_actuator_noise=false",

        # factors keep as 1 (since rand=0 already)
        "--server::prand_factor_l=1",
        "--server::prand_factor_r=1",
        "--server::kick_rand_factor_l=1",
        "--server::kick_rand_factor_r=1",

        # ----------------------------
        # NO WIND (safe set)
        # ----------------------------
        "--server::wind_random=false",
        "--server::wind_force=0",
        "--server::wind_rand=0",
        "--server::wind_ang=0",
        "--server::wind_dir=0",
        ...
        # ----------------------------
        # REMOVE hetero player params
        # ----------------------------
        "--player::random_seed=1",
        "--player::player_decay_delta_max=0",
        "--player::player_decay_delta_min=0",
        ...
        "--player::kickable_margin_delta_max=0",
        "--player::kickable_margin_delta_min=0",
        "--player::extra_stamina_delta_max=0",
        "--player::extra_stamina_delta_min=0",

        # ----------------------------
        # QUANTIZE (for exact reverse)
        # ----------------------------
        "--server::quantize_step=0.000001",
        "--server::quantize_step_l=0.000001",

        # optional: avoid tiny-speed special handling
        "--server::stopped_ball_vel=0.000001",
        "--server::sense_body_step=100",
        "--server::send_vi_step=100",
    ]
